...
namespace ClassLibrary2
{
    ...
    public class EntityDataStore<TKey, TEntity> : IEntityDataStore<TKey, TEntity> where TEntity : TableEntity, IEntity, new()
    {
            ...
            TKey id)
        {
            ...
            {
                var entity =
                    await this.GetByIdAsync(id.ToString(), _primaryCloudTable);
            ...
            catch
            {
                ...
                {
                    var entity =
                        await this.GetByIdAsync(id.ToString(), _secondaryCloudTable);
        ...
        {
            var tableOperation =
                TableOperation.Retrieve<TEntity>(id, id);
